...
//!
//! `pal::hal` exists beside the other fusion-pal contract modules for the places where hardware
//! truth is not reducible to “what system call exists.” It defines the queries higher
//! layers may ask about ISA, stack ABI, and topology, while leaving the actual evidence
//! gathering to selected providers such as [`crate::hal`].
