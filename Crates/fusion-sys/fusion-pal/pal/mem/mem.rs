...
//! selected fusion-pal backend. The types here describe what a backend can actually map,
...
///
/// This keeps the fusion-pal memory contract platform-independent while still forcing safe callers to
...
/// Error returned by low-level fusion-pal memory operations.
#[derive(Debug, Clone, Copy, PartialEq, Eq, Hash)]
pub struct MemError {
