...
use super::{
    ...
    allocator_layout_from_page_info,
    backing_kind_from_request,
    build_resolved_resource,
    finalize_post_map_state,
    geometry_from_page_info,
    initial_map_flags,
    normalize_len,
    preferred_placement_to_mem,
    request_backing_to_mem,
    required_placement_to_mem,
    resource_acquire_support_from_mem_support,
    resource_attrs_for_request,
    resource_attrs_from_request,
    supports_huge_page_advice,
    supports_map_time_huge_pages,
    validate_request,
        ...
        Ok(MaterializedReservation {
            ...
            resource: VirtualMemoryResource::from_parts(
                ...
                build_resolved_resource(
                    ...
                    allocator_layout_from_page_info(self.page_info),
                    unmet,
