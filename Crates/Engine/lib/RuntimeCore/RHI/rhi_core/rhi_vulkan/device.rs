...
impl VulkanRHI {
    fn vk_create_swapchain(
        ...
        let swap_chain_support_result = unsafe {
    ...
    fn vk_create_render_pass(device: &ash::Device) -> Result<vk::RenderPass> {
        let mut attachment_description: vk::AttachmentDescription2 =
        ...
        let mut attachment_reference: vk::AttachmentReference2 =
