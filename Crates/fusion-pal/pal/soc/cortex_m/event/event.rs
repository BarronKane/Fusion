...
fn reserved_timeout_irq() -> Option<u16> {
    crate::pal::soc::cortex_m::hal::soc::board::event_timeout_irq()
}
...
fn validate_registration_mode(irqn: u16, mode: EventRegistrationMode) -> Result<(), EventError> {
    match mode {
        ...
        EventRegistrationMode::LevelAckOnPoll | EventRegistrationMode::OneShot => {
            if crate::pal::soc::cortex_m::hal::soc::board::irq_acknowledge_supported(irqn) {
                Ok(())
            } else {
...
fn board_irq_enable(irqn: u16) -> Result<(), EventError> {
    crate::pal::soc::cortex_m::hal::soc::board::irq_enable(irqn).map_err(map_hardware_error)
}

fn board_irq_disable(irqn: u16) -> Result<(), EventError> {
    crate::pal::soc::cortex_m::hal::soc::board::irq_disable(irqn).map_err(map_hardware_error)
}

fn board_irq_acknowledge(irqn: u16) -> Result<(), EventError> {
    crate::pal::soc::cortex_m::hal::soc::board::irq_acknowledge(irqn).map_err(map_hardware_error)
}
...
fn cancel_board_timeout() -> Result<(), EventError> {
    ...
    crate::pal::soc::cortex_m::hal::soc::board::cancel_event_timeout().map_err(map_hardware_error)
}
