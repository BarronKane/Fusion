//! Capability vocabulary for fusion-pal user-space context switching.
...
pub use crate::contract::caps::AuthoritySet as ContextAuthoritySet;
...
pub use crate::contract::caps::Guarantee as ContextGuarantee;
/// Shared implementation-category vocabulary specialized for context support.
pub use crate::contract::caps::ImplementationKind as ContextImplementationKind;
