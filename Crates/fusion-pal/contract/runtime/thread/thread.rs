...
//! A sibling hardware authority such as [`crate::hal`] or the backend-neutral
//! [`crate::contract::hal`] contract is expected to enumerate valid logical CPUs, packages,
...
pub use crate::contract::hal::HardwareTopologyNodeId;
pub use caps::*;
pub use config::*;
pub use error::*;
pub use id::*;
