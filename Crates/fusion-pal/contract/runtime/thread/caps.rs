...
pub use crate::contract::caps::AuthoritySet as ThreadAuthoritySet;
/// Shared guarantee ladder specialized for thread support.
pub use crate::contract::caps::Guarantee as ThreadGuarantee;
/// Shared implementation-category vocabulary specialized for thread support.
pub use crate::contract::caps::ImplementationKind as ThreadImplementationKind;
