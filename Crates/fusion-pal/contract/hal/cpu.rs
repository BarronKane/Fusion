...
pub type HardwareTopologyNodeId = crate::contract::hardware::mem::MemTopologyNodeId;
...
impl From<crate::contract::runtime::context::ContextStackDirection> for HardwareStackDirection {
    fn from(value: crate::contract::runtime::context::ContextStackDirection) -> Self {
        match value {
            crate::contract::runtime::context::ContextStackDirection::Unknown => Self::Unknown,
            crate::contract::runtime::context::ContextStackDirection::Down => Self::Down,
            crate::contract::runtime::context::ContextStackDirection::Up => Self::Up,
        }
    }
}
