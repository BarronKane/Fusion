...
pub use crate::contract::caps::AuthoritySet as HardwareAuthoritySet;
/// Shared guarantee ladder specialized for hardware support.
pub use crate::contract::caps::Guarantee as HardwareGuarantee;
/// Shared implementation-category vocabulary specialized for hardware support.
pub use crate::contract::caps::ImplementationKind as HardwareImplementationKind;
