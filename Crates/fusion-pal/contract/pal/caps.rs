...
//! context, event, and interconnect contracts.
...
pub use AuthoritySet as HardwareAuthoritySet;
/// Shared guarantee ladder specialized for hardware support.
pub use Guarantee as HardwareGuarantee;
/// Shared implementation-category vocabulary specialized for hardware support.
pub use ImplementationKind as HardwareImplementationKind;
