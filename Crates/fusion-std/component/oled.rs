//! OLED display component backed by owned I2C GPIO lines.
//!
...
//! to a future I2C/display contract; this component owns the pins and exposes the wiring truth.
...
where
    ...
    Sda: GpioOutputPin,
{
    /// Creates one OLED display component by claiming the SCL and SDA pins.
    ///
