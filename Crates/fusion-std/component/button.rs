//! Simple button components backed by owned GPIO inputs.

use fusion_sys::gpio::{GpioError, GpioInputPin};

/// Simple binary button component backed by one owned GPIO input.
#[derive(Debug)]
pub struct Button<P> {
    pin: P,
    active_high: bool,
