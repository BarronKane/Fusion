//! Simple buzzer components backed by owned GPIO outputs.
//!
...
//! left to the caller or a future PCU/timer contract; these components own the GPIO pin and
...
/// Simple buzzer component backed by one owned GPIO output.
///
