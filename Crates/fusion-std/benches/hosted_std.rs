...
bench_wrap_ignore!(
    green_pool_lifecycle_noop_carriers_1,
    "hosted green lifecycle is measured by fusion_std_fiber_lifecycle_probe because libtest still stalls on this path"
);
bench_wrap_ignore!(
    green_pool_lifecycle_noop_carriers_2,
    "hosted green lifecycle is measured by fusion_std_fiber_lifecycle_probe because libtest still stalls on this path"
);
bench_wrap_ignore!(
    green_pool_lifecycle_noop_carriers_4,
    "hosted green lifecycle is measured by fusion_std_fiber_lifecycle_probe because libtest still stalls on this path"
);
bench_wrap_ignore!(
    green_pool_lifecycle_yield_once_carriers_1,
    "hosted green lifecycle is measured by fusion_std_fiber_lifecycle_probe because libtest still stalls on this path"
);
bench_wrap_ignore!(
    green_pool_lifecycle_yield_once_carriers_2,
    "hosted green lifecycle is measured by fusion_std_fiber_lifecycle_probe because libtest still stalls on this path"
);
bench_wrap_ignore!(
    green_pool_lifecycle_yield_once_carriers_4,
    "hosted green lifecycle is measured by fusion_std_fiber_lifecycle_probe because libtest still stalls on this path"
);
