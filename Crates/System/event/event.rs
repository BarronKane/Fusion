//! System-level event wrappers built on top of PAL-truthful backends.
//!
//! `fusion-sys::event` is the narrow policy-free layer above the PAL event contracts. It
...
/// System event provider wrapper around the selected PAL backend.
