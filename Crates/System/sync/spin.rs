...
/// last-resort fallback where a stronger PAL-backed mutex is unavailable.
///
/// TODO: Replace spin fallback usage with stronger PAL-backed mutexes on platforms that grow
