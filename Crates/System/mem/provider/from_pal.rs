//! Adapter helpers for translating normalized PAL catalog truth into provider descriptors.
//!
//! These helpers are intentionally explicit. Provider and PAL keep distinct type systems so
...
/// Converts a PAL catalog resource into a broad provider memory-object descriptor.
#[must_use]
...
/// Converts a PAL catalog resource into a pool-capable provider resource descriptor.
///
...
/// Converts a PAL catalog strategy into a provider strategy descriptor.
#[must_use]
...
/// Converts a PAL topology node into the provider topology vocabulary.
#[must_use]
...
/// Converts a PAL topology link into the provider topology vocabulary.
#[must_use]
