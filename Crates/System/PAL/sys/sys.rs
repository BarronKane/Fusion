...
//! - Apple targets do not offer a public stable syscall ABI in the same way, so serious PAL
...
//!   public stable raw syscall contract suitable for a portable PAL to own directly.
//!
//! The PAL therefore treats backend truth and backend auditability as first-class concerns.
