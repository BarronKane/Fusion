//! Backend-neutral user-space execution context vocabulary and unsafe PAL traits.
//!
//! This surface exists for stackful cooperative execution contexts such as fibers or green
//! threads. It is intentionally narrower than any specific platform coroutine API: the PAL
