...
bitflags::bitflags! {
    /// Set of memory domains a PAL catalog can describe or acquire.
...
pub enum MemDomain {
    ...
    VirtualAddressSpace,
    /// Device-local memory exposed through the PAL.
    DeviceLocal,
...
bitflags::bitflags! {
    /// Coarse catalog capabilities reported by a PAL backend.
    #[derive(Debug, Clone, Copy, PartialEq, Eq, Hash)]
