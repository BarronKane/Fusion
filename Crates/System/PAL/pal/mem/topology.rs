...
/// Stable identifier for a topology node in the PAL memory catalog.
#[derive(Debug, Clone, Copy, PartialEq, Eq, Hash)]
pub struct MemTopologyNodeId(pub u32);

/// Stable identifier for a topology link in the PAL memory catalog.
#[derive(Debug, Clone, Copy, PartialEq, Eq, Hash)]
pub struct MemTopologyLinkId(pub u32);

/// Kind of node present in the PAL topology model.
#[derive(Debug, Clone, Copy, PartialEq, Eq, Hash)]
...
/// Topology node descriptor surfaced by a PAL memory catalog.
#[derive(Debug, Clone, Copy, PartialEq, Eq, Hash)]
...
/// Topology link descriptor surfaced by a PAL memory catalog.
#[derive(Debug, Clone, Copy, PartialEq, Eq, Hash)]
