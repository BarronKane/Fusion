//! Backend-neutral thread vocabulary and low-level PAL contracts.
//!
//! Threading is the first PAL surface where truthful capability reporting depends on more
...
/// Raw thread entry point type used by PAL backends.
///
/// # Safety
///
...
/// platform's native thread-entry ABI and this PAL-level signature. The function must
...
/// Opaque thread return code surfaced by a PAL join operation.
...
/// Base thread support surface for a selected PAL backend.
...
/// Thread lifecycle operations implemented by a selected PAL backend.
///
/// # Safety
///
...
/// External thread suspension control for a selected PAL backend.
...
/// Scheduler control and voluntary execution operations for a selected PAL backend.
...
/// Placement and locality control for a selected PAL backend.
...
/// Thread observation operations for a selected PAL backend.
...
/// Stack-usage observation for a selected PAL backend.
